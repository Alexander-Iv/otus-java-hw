package alexander.ivanov.webserver.models.hibernate.data.impl;
...
public class HibernateConfig implements Config {
    private static final String CONFIG_FILE_PATH = "alexander/ivanov/webserver/config/hibernate/hibernate.cfg.xml";
